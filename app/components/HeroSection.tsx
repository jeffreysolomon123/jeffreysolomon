...
export default function HeroSection({
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <button
                ...
                style={{
                  background: "linear-gradient(to right, #FFFFFF, #b1b1b3)", // <-- your hex here
                }}
                className="
  ...
  "
              ...
              <button
                ...
                className="rounded-xl border cursor-pointer border-white/25 bg-black/40 px-6 py-2.5 text-sm font-medium text-white/80 backdrop-blur transition hover:border-white/50 hover:bg-black/60 geist-regular"
              >
                Download resume
              </button>
            </div>
